...
$curl = curl_init();
    ...
    $array1['productName']='Graphic Design';
 ...
 if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Graphic Design';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Graphic%20Design",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=Graphic%20Design&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>Graphic Design</h2><br><br>
                  <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/design.jpg"><br><br>
             <p>  Graphic design is the process of visual communication and problem-solving through the use of typography, photography and illustration. The field is considered a subset of visual communication and communication design, but sometimes the term "graphic design" is used synonymously. Graphic designers create and combine symbols, images and text to form visual representations of ideas and messages. They use typography, visual arts and page layout techniques to create visual compositions. Common uses of graphic design include corporate design (logos and branding), editorial design (magazines, newspapers and books), wayfinding or environmental design, advertising, web design, communication design, product packaging and signage.</p>
              ...
              <?php
		 $_SESSION['productName'] = 'Graphic Design';
      

              $random = mt_rand();
              setcookie("Page[$random]","Graphic Design",(time()+86400), '/');
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","Graphic Design");

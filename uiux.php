...
$curl = curl_init();
    ...
    $array1['productName']='UI/UX Design';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='UI/UX Design';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=UI/UX%20Design",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=UI/UX%20Design&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
    ...
    <body>
        ...
        <div class="section primary-section">
		 ...
		 $_SESSION['productName'] = 'UI/UX Design';
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","UI/UX Design");

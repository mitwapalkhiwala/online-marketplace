...
$curl = curl_init();
    ...
    $array1['productName']='Android Apps Development';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Android Apps Development';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Android%20Apps%20Development",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=Android%20Apps%20Development&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
<script>
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>Android Apps Development</h2><br><br>
                  <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/android-2.jpg"><br><br>
                <p>Mobile apps have the advantage of utilizing features of a mobile device like camera, contact list, GPS, phone calls, accelerometer, compass, etc. 
Such device features, when used within an app, can make the user experience interactive and fun. We develop all kinds of Android mobile applications as per your requirements. </p>
                      <?php
			$_SESSION['productName'] = 'Android Apps Development';
			                      $random = mt_rand();
                      setcookie("Page[$random]","Android Apps Development",(time()+86400), '/');
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","Android Apps Development");

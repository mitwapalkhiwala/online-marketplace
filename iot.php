...
$curl = curl_init();
    ...
    $array1['productName']='Internet of Things Development';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Internet of Things Development';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Internet%20of%20Things%20Development",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=Internet%20of%20Things%20Development&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
<script>
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>Internet of Things Development</h2><br><br>
                <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/iot.png"><br><br>
            <p>The internet of things, or IoT, is a system of interrelated computing devices, mechanical and digital machines, objects, animals or people that are provided with unique identifiers ( UIDs ) and the ability to transfer data over a network without requiring human-to-human or human-to-computer interaction.</p>
              <?php
		 $_SESSION['productName'] = 'Internet of Things Development';
              

              $random = mt_rand();
              setcookie("Page[$random]","Internet of Things Development",(time()+86400), '/');
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","Internet of Things Development");

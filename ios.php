...
$curl = curl_init();
    ...
    $array1['productName']='iOS Apps Development';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='iOS Apps Development';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=iOS%20Apps%20Development",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=iOS%20Apps%20Development&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
<script>
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>iOS Apps Development</h2><br><br>
                <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/apple.jpg"><br><br>
                <p>Mobile apps have the advantage of utilizing features of a mobile device like camera, contact list, GPS, phone calls, accelerometer, compass, etc. Such device features, when used within an app, can make the user experience interactive and fun. We develop all kinds of iOS mobile applications as per your requirements.</p>
              <?php
             
	      $_SESSION['productName'] = 'iOS Apps Development';
              
              
              $random = mt_rand();
              setcookie("Page[$random]","iOS Apps Development",(time()+86400), '/');
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","iOS Apps Development");

...
$curl = curl_init();
    ...
    $array1['productName']='eCommerce Development';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='eCommerce Development';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=eCommerce%20Development",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=eCommerce%20Development&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
<script>
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>eCommerce Development</h2><br><br>
                <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/ecommerce-2.jpg"><br><br>
...
Whereas e-business refers to all aspects of operating an online business, ecommerce refers specifically to the transaction of goods and services.</p>
           
              <?php
		 $_SESSION['productName'] = 'eCommerce Development';
             

              $random = mt_rand();
              setcookie("Page[$random]","eCommerce Development",(time()+86400), '/');
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","eCommerce Development");

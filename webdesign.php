...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Web Design';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Web%20Design",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=Web%20Design&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
<script>
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>Web Design</h2><br><br>
                 <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/web-design.jpg"><br><br>
            <p>Web design encompasses many different skills and disciplines in the production and maintenance of websites. The different areas of web design include web graphic design; interface design; authoring, including standardised code and proprietary software; user experience design; and search engine optimization.</p>
              ...
              <?php
	      $_SESSION['productName'] = 'Web Design';
            
              $random = mt_rand();
              setcookie("Page[$random]","Web Design",(time()+86400), '/');
	       if(!isset($_COOKIE["all_companies_visited_pages"])){
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","Web Design");

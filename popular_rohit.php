...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/mostVisitedInd.php?companyName=BHAGYADEEP%20TOURS%20AND%20TRAVELS",
...
<html lang="en">
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">   
                <h2>5 Most Visited Services on BHAGYADEEP TOURS AND TRAVELS</h2><br>
                      <?php

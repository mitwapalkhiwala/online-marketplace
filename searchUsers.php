                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
                            <li class="active"><a href="http://www.mitwapalkhiwala.com">Go Back</a></li>
                        </ul>
                    </div>
                    <!-- End main navigation -->
                </div>
...
if($criteria != ''){
$sql = "SELECT firstName, lastName, email, address, homePhone, cellPhone FROM user where $criteria = '$searchText'";

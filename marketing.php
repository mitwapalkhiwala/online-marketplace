...
$curl = curl_init();
    ...
    $array1['productName']='Content Marketing';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Content Marketing';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Content%20Marketing",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=Content%20Marketing&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
<script>
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>Content Marketing</h2><br><br>
             <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/content.jpg"><br><br>
            <p>Content marketing is a strategic marketing approach focused on creating and distributing valuable, relevant, and consistent content to attract and retain a clearly defined audience — and, ultimately, to drive profitable customer action.</p>
              ...
              <?php
 $_SESSION['productName'] = 'Content Marketing';
              

              $random = mt_rand();
              setcookie("Page[$random]","Content Marketing",(time()+86400), '/');
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","Content Marketing");

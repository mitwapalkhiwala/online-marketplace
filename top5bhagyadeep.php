...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/getTopFiveInd.php?companyName=BHAGYADEEP%20TOURS%20AND%20TRAVELS",
...
<html lang="en">
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">   
                <h2>Top 5 Services on BHAGYADEEP TOURS AND TRAVELS</h2><br>
                      <?php
              
		    $json = json_decode($response, true);
		echo "<table><tr><td><h4><b> Service Name</b></h4> </td><td></td><td></td><td><h4><b> Ratings </b></h4></td></tr>";
		echo "<tr><td></td></tr>"; echo "<tr><td></td></tr>";echo "<tr><td></td></tr>";echo "<tr><td></td></tr>";
		  for($i=0; $i<sizeof($json); $i++){
			echo "<tr><td > " . $json[$i]['productName']. "</td><td></td><td></td><td style='text-align: center;'>" . $json[$i]['rating']."</td></tr>";      
		  }
                  echo "</table>";         

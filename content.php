...
$curl = curl_init();
    ...
    $array1['productName']='Content Creation';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Content Creation';
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Content%20Creation",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/showUserRating.php?productName=Content%20Creation&email=$email_new",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
...
<script>
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>Content Creation</h2><br><br>
                  <img style="margin-left:auto;margin-right:auto;display:block;left:0;right:0;" src="images/laptop.jpg!d"><br><br>
                  <p>Content creation is the process of identifying a new topic you want to write about, deciding which form you want the content to take, formalizing your strategy (keyword or otherwise), and then actually producing it.

In addition, most content creation processes involve thorough rounds of edits with other stakeholders before content is ready for publish.</p>
              <?php
		 $_SESSION['productName'] = 'Content Creation';
            

              $random = mt_rand();
              setcookie("Page[$random]","Content Creation",(time()+86400), '/');
              ...
              $count1=$count1+1;
              setcookie("all_companies_visited_pages[".$count1."]","Content Creation");

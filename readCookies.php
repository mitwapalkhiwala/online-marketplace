...
<html lang="en">
    ...
    <body>
        ...
        <div class="section primary-section">
            ...
            <div class="container">
                <h2>Last 5 Visited Services:</h2><br><br>
             
              <div>
              <?php
              $random = mt_rand();
              setcookie("Page[$random]","Cookies",(time()+86400), '/');
              ...
              $info = preg_replace("/,/", "<br><br>", implode( ',', array_reverse($array) ));
              echo $info;
              }
              
              else{
                  echo "You have not visited any services yet!";
              }
              }
              else{
                  echo "You have not visited any services yet!";

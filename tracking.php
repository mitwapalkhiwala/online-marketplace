...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/getTracking.php?email=$email",
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    "postman-token: 372948d6-bd37-5f17-cb51-0a8952688392"
  ),
));
...
<body>
        ...
        <div class="section primary-section">
          	  <div class="triangle"></div>
     		       <div class="container">
           		     <h2><b>You have visited the following services in the marketplace</b></h2><br><hr><br>

...
<html lang="en">
    ...
    <body>
        ...
        <div id="database">
      <?php 
$url1='http://www.mitwapalkhiwala.com/curl.php '; 
$url2='http://www.rohitsapkal.com/allUsers.php';
$url3='http://thetechsp.com/curlTestUserList.php';

echo "<h3>www.mitwapalkhiwala.com Users:<br><br></h3>";
print_r(get_data($url1));

echo "<h3><br><br>www.rohitsapkal.com Users:<br><br></h3>";
print_r(get_data($url2)); 

echo "<h3><br><br>www.thetechsp.com Users:<br><br></h3>";
print_r(get_data($url3)); 
